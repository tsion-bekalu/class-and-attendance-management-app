...
class ClassManagementSplashScreen extends StatefulWidget {
  ...
  @override
  State<ClassManagementSplashScreen> createState() => _ClassManagementSplashScreenState();
}

class _ClassManagementSplashScreenState extends State<ClassManagementSplashScreen> {
  @override
  void initState() {
    super.initState();
